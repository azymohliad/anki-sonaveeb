# Anki доповнення для інтеграції з Sõnaveeb

Доповнення до [Anki](https://apps.ankiweb.net/) для автоматизації створення флеш-карток для тренування естонського словникового запасу.
